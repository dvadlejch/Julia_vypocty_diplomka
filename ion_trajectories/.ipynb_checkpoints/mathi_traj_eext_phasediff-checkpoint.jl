...
function get_mathi_traj(Vrf, Udc, Ω, u0_vec, E_ext, delta_phi_au, phi, tspan; div=false, sym_type=false)
    ...
    u0 = u0_vec[4:6] # amplitudy vychylky - implicitne predpokladame nulove poc. rychlosti
    us = e./(m*ω.^2) .* E_ext
